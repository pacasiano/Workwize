    ...
    return (
        <div className={` ${Wide ? ("w-60") : ("w-20")} h-full bg-black/90 transition-all ease-in-out`}>
            ...
            <div className="relative flex flex-col items-start justify-start p-8">
                ...
                <Link to={"/home"} className="flex flex-row gap-2 text-white font-thin text-md group rounded-xl bg-white/0 text-white/70 hover:cursor-pointer hover:text-white"><div className="mb-2">{"< "}</div>Return </Link>
                <h1 className="flex flex-row gap-2 text-white text-2xl font-mono break-all">{data.project_name}</h1>
                ...
                <div className="flex flex-col items-start justify-start gap-10 pt-10">
                    ...
                    <div className="flex flex-col text-xl gap-3">
                        <Link to={"/project/dashboard"} className="flex flex-row gap-2 transition-all hover:-translate-y-[2px] hover:cursor-pointer items-center text-white py-1 px-2 rounded-md">
                            <FontAwesomeIcon className="text-2xl" icon={faBorderAll} /><p>Dashboard</p>
                        </Link>
                        <Link to={"/project/tasks"} className="flex flex-row gap-2 transition-all hover:-translate-y-[2px] hover:cursor-pointer items-center text-white py-1 px-2 rounded-md">
                            <FontAwesomeIcon className="text-2xl" icon={faListCheck} />Tasks
                        </Link>
                        <Link to={"/project/calendar"} className="flex flex-row gap-2 transition-all hover:-translate-y-[2px] hover:cursor-pointer items-center text-white py-1 px-2 rounded-md">
                            <FontAwesomeIcon className="text-2xl" icon={faCalendar} />Calendar
                        </Link>
                        <Link to={"/project/settings"} className="flex flex-row gap-2 transition-all hover:-translate-y-[2px] hover:cursor-pointer items-center text-white py-1 px-2 rounded-md">
            ...
            <div className="flex flex-col items-center justify-start pt-6 px-4 transition-all">
                ...
                <Link to={".."} relative="path" className="flex flex-row gap-2 text-white font-bold text-3xl bg-white/0 text-white/70 hover:cursor-pointer hover:text-white"><div className="mb-2">{"< "}</div></Link>
