                ...
                <div className="flex flex-row gap-5 overflow-x-auto p-10 ">
                    ...
                    <div key={index} className="flex flex-row gap-2 p-4 rounded-xl h-full bg-white/80 shadow-xl">
                        <div className="flex flex-col gap-3 ">
                            ...
                            <div onClick={() => setAddProj({show: true, data: {name: task.name, color: task.color } })} className="flex flex-row gap-2 justify-start items-center w-min px-1 rounded-md hover:bg-neutral-200 hover:cursor-pointer">
